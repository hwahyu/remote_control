...
//  Bluetooth_joystick
//
//  Created by Hendra Wahyu on 4/13/17.
...
public struct joystickData: CustomStringConvertible {
    ...
    public var angle: CGFloat = 0.0         //initial value
...
@IBDesignable
public class joystickController: UIView {
    ...
    public var trackingHandler: ((joystickData) -> Void)?
    ...
    public override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        data = joystickData(velocity: CGPoint(x: x, y: y), angle: ((-atan2(x, y) + CGFloat(Double.pi))))
        //print(data)
    }
